    ...
    def webhook_skin_write_file(self, block_snipe):
        ...
        with requests.session() as session:
            ...
            for hook in config.webhooks:
                ...
                with session.post(hook, json={"embeds": [{"title": "New Snipe 🎉", "description": f"Sniped `{target_username}` with {searches} searches using DaBaby!", "color": 65395}]}) as r:
